...
testing:
1. I try to display the environment data separately.
2. I try to print the coordinates of wolf and sheep, recording sheep were killed by wolves.
3. I try to print the store between sheep in each frame and total records.
4. I try to print the frame number, to see how many frames when the model stops running.
5. I try to print the restricted 100 coordinates, scraping on the web (data.html).
