...
def set_parameter():
    ...
    if int(number.get()) > num_of_agents:
...
random.seed(1)
num_of_wolf = 3
#num_of_agents = 10 #Create ten agents
num_of_agents = 96
...
for i in range(num_of_agents): # Create a new set of coordinates, put into for-loop
    ...
    agents.append(agentframework.Agent(i,agents,environment,y,x,color[z]))
...
for j in range(num_of_wolf): # Create a new set of coordinates, put into for-loop
    ...
    wolf.append(wolf_framework.wolf(j,wolf,y,x,'Black'))
