...
This file is used to build the agent-based model, including making agents and behavior of agents,
having the function of interecting with user through designing a simple GUI.
@author: Yanfeng Li
"""
import random
import operator
...
def catch(a,b):
    ...
    Agents need to know who is near them so they can decide 
    whether or not to interact with other agents.
    Parameters
    ----------
    a : Sheep
        DESCRIPTION.
...
#text= tkinter.Text(root,width=15, height=8).grid(row=5, column=0)
