...
2.  I try to add a text widget in Tkinter which is used to show the score of distance between sheep, but i failed. When i run the model , there is no new socres in the text widget.

testing:
1. I try to print the coordinates of wolf and sheep, ensurinng the sheep were killed by wolf.
2. I try to pirnt the score of sheep to see if the score is corret.

Some ideas for further development:
1. Show the score in the GUI correctly.
